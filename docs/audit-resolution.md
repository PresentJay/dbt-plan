...
| [#163](https://github.com/PresentJay/dbt-plan/issues/163) | Repair the sample upstream projections and regenerate English and Korean showcase output from the resolver-backed CLI result. | `test_audit24_docs.py`; `examples/sample-project/output.txt` |
