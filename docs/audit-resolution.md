...
| [#145](https://github.com/PresentJay/dbt-plan/issues/145) | Unsupported graph operators and unknown names are execution errors, never empty successful checks. | `test_audit24_cli.py`, `test_select_graph.py` |
